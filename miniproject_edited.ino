...
void loop()
{
  ...
  { 
    ...
    else if(distance1<=35 && distance1>=15) // this condition will true if we place our hand in front of the right sensor for more then 300 milli seconds. 
    {
     temp=distance1;                         // store the current position of our hand in the variable temp. 
     while(distance1<=50 || distance1==0)    // this loop will run untill we removes our hand in front of the right sensor.
     {
       find_distance();                      // call this function continuously to get the live data. 
